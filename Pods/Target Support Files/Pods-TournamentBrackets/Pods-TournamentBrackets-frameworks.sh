...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-TournamentBrackets/AKPickerView.framework"
  install_framework "Pods-TournamentBrackets/Charts.framework"
  ...
  install_framework "Pods-TournamentBrackets/RxDataSources.framework"
  install_framework "Pods-TournamentBrackets/RxRealm.framework"
